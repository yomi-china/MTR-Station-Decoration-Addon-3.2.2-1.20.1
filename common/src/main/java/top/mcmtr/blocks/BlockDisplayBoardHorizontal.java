...
public class BlockDisplayBoardHorizontal extends BlockChangeModelBase {
    public BlockDisplayBoardHorizontal() {
        super(6, Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(2.0F).lightLevel((state) -> 5));
    }
